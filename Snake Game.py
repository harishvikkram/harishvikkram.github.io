...
pygame.display.set_caption('Green Snake Game')
...
def snake(blockSize, snakelist):
    ...
    for size in snakelist:
        ...
        pygame.draw.rect(gameDisplay,lightgreen,[size[0]+5,size[1],blockSize,blockSize],2)
...
def gameLoop():
    ...
    while not gameExit:
        ...
        pygame.draw.rect(gameDisplay,lightgreen, [randomAppleX,randomAppleY,AppleThickness,AppleThickness])
